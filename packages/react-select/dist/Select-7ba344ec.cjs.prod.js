...
var _objectWithoutProperties = require("@babel/runtime/helpers/objectWithoutProperties"), _extends = require("@babel/runtime/helpers/extends"), _slicedToArray = require("@babel/runtime/helpers/slicedToArray"), _toConsumableArray = require("@babel/runtime/helpers/toConsumableArray"), index = require("./index-1d123a5d.cjs.prod.js"), _classCallCheck = require("@babel/runtime/helpers/classCallCheck"), _createClass = require("@babel/runtime/helpers/createClass"), _assertThisInitialized = require("@babel/runtime/helpers/assertThisInitialized"), _inherits = require("@babel/runtime/helpers/inherits"), React = require("react"), memoizeOne = require("memoize-one"), core = require("@emotion/core"), reactDom = require("react-dom");
  ...
  return _createClass__default.default(Select, [ {
    ...
    value: function() {
      var _this$props14 = this.props, isDisabled = _this$props14.isDisabled, isSearchable = _this$props14.isSearchable, inputId = _this$props14.inputId, inputValue = _this$props14.inputValue, tabIndex = _this$props14.tabIndex, form = _this$props14.form, Input = this.components.Input, inputIsHidden = this.state.inputIsHidden, id = inputId || this.getElementId("input"), ariaAttributes = {
        ...
        "aria-owns": this.getElementId("menu"),
    ...
    value: function() {
      ...
      }, menuId = this.getElementId("menu"), menuElement = React__default.default.createElement(index.MenuPlacer, _extends__default.default({}, commonProps, menuPlacementProps), (function(_ref10) {
