...
import { jsx, keyframes, css as css$2, ClassNames } from '@emotion/core';
...
var MenuList = function MenuList(props) {
  var children = props.children,
      ...
      innerRef = props.innerRef,
      innerProps = props.innerProps,
      id = props.id; // aria attributes makes the JSX "noisy", separated for clarity
  ...
  return jsx("div", _extends({
    ...
    ref: innerRef
  }, ariaAttributes, innerProps), children);
}; // ==============================
// Menu Notices
// ==============================
